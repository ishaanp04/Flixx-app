const global = {
  ...
  api: {
    apiKey: 'f8b54a8716c6938eb11b6b29a7481ade',
  ...
  div.innerHTML = `
    <div class="details-top">
        ...
        <div class="details-bottom">
          <h2>Show Info</h2>
          <ul>
            <li><span class="text-secondary">Number Of Episode:</span> ${addCommasToNumber(
...
function displayBackdropImage(type, backdrop_path) {
...
function displaySearchResults(results) {
  ...
  // console.log(document.querySelector('#search-results').innerHTML);
...
// Proving myself to aryan (i failed)
async function onPageChange(i) {
  global.search.page = i;
...
function displayPagination() {
  ...
  // let buttons = '';
  // for (let i = 1; i <= global.search.totalPages; i++) {
  //   const btn = `<button class="btn btn-primary" onclick=onPageChange(${i})>${i}</button>`;
